...
namespace API.Migrations
{
    ...
    [Migration("20220531040815_add_account_profiling_education_university_model")]
    partial class add_account_profiling_education_university_model
    {
            ...
            modelBuilder.Entity("API.Employee", b =>
                {
                    b.HasOne("API.Models.Account", "Account")
                        .WithOne("Employee")
                        .HasForeignKey("API.Employee", "NIK")
